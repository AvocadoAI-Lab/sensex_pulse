...
export class ReportTemplateService {
    ...
    public static generateTemplate(summary: GroupSummary): string {
        ...
        <body>
            ...
            ${this.generateRestOfTemplate(summary, activeAgents)}
        </body>
        </html>`;
    }

    private static generateRestOfTemplate(summary: GroupSummary, activeAgents: AgentSummary[]): string {
        return `
            <!-- Table of Contents -->
            <section id="table-of-contents" class="page toc-page">
            ...
            <!-- Executive Summary -->
            <section id="executive-summary" class="page report-page">
                ${generateExecutiveSummary(summary)}
                ${this.generateBackToTocButton()}
            </section>

            <!-- Vulnerability Analysis -->
            <section id="vulnerability-analysis" class="page report-page">
                ${generateVulnerabilityAnalysis(summary)}
                ${this.generateBackToTocButton()}
            </section>

            <!-- MITRE Analysis -->
            <section id="mitre-analysis" class="page report-page">
